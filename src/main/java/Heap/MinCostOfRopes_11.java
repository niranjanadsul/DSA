...
public class MinCostOfRopes_11 {
    ...
    then connect 4 and 5 to get [9, 6] with a cost of 9, and finally connect 9 and 6
    to get one rope with a cost of 15, giving a total minimum cost of 29.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(minCost(new int[]{4,2,7,6,9}));//62
    }
}
